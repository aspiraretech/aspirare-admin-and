...
angular.module('smartAdminApp')
    .controller('TakeAttendanceController', function($scope, $state, $ionicPopover, ionicDatePicker, TakeAttendanceFactory, SelectClassFactory, LoginFactory, ionicToast, $ionicHistory) {
        ...
        var ipObj1 = {
            callback: function(val) { //Mandatory
                $scope.selected.attendanceDate = moment(val).format('YYYY-MM-DD H:mm:ss');
            },
