...
angular.module('smartAdminApp')
    .controller('AddEnquiryController', function($scope, ionicToast, LoginFactory, $state, EnquiriesFactory, SelectSemesterFactory, ionicDatePicker, $stateParams, DashboardFactory) {
