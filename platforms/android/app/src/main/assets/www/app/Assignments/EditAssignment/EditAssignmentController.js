...
angular.module('smartAdminApp')
    .controller('EditAssignmentController', function($scope, $state, AssignmentFactory, ionicToast, $ionicHistory, $sce, $ionicPopup, $ionicPopover, $cordovaInAppBrowser, $ionicLoading, $cordovaFileTransfer, $cordovaSocialSharing, $q, LoginFactory) {
